...
export default {
  ...
  data() {
    return {
      api_key: '7f306d5a5e92d1ac1f88a08238b8cbd1',
  ...
  methods: {
    ...
    dateBulider () {
      ...
      let days = ["Sunday", "Monday", "Tuesday", "Wedndsday", "Thursday", "Friday", "Saturday"];
  ...
  // created() {
  //   const vm = this;
  //   const api = `https://api.openweathermap.org/data/2.5/weather?q=${this.city}&units=imperial&APPID=${this.APIkey}`;
...
#app.rain {
  background-image: url('./assets/bg-img-rain.jpeg');
}
